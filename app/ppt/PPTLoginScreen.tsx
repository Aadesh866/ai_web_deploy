...
import { Lock, User, Eye, EyeOff, AlertCircle, Loader2, LogIn } from "lucide-react";

interface PPTLoginScreenProps {
  onAuthenticated: () => void;
}

export default function PPTLoginScreen({ onAuthenticated }: PPTLoginScreenProps) {
