                        ...
                        <div className="space-y-6">
                            <ScrollReveal delay={0.2}>
                                <div className="interactive-card p-6">
                                    ...
                                    <a href="https://calendly.com/purplehub/30min" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-sm font-semibold text-primary-brand hover:gap-3 transition-all">
